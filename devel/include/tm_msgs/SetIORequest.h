...
struct SetIORequest_
{
  ...
  _value_type value;
    ...
    enum { FUN_SET_MB_DIGITAL_OUT = 1 };
     enum { FUN_SET_MB_ANALOG_OUT = 2 };
     enum { FUN_SET_EE_DIGITAL_OUT = 3 };
     enum { FUN_SET_EE_ANALOG_OUT = 4 };
...
// {'tm_msgs': ['/home/schwarmcyc/Documents/techman_robot/src/techman_robot/tm_msgs/msg'], 'std_msgs': ['/opt/ros/indigo/share/std_msgs/cmake/../msg']}
