...
if("TRUE" STREQUAL "TRUE")
  set(tm_driver_SOURCE_PREFIX /home/schwarmcyc/Documents/techman_robot/src/techman_robot/tm_driver)
  set(tm_driver_DEVEL_PREFIX /home/schwarmcyc/Documents/techman_robot/devel)
  ...
  set(tm_driver_INSTALL_PREFIX /home/schwarmcyc/Documents/techman_robot/install)
...
if(NOT "/home/schwarmcyc/Documents/techman_robot/src/techman_robot/tm_driver/include " STREQUAL " ")
  set(tm_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/schwarmcyc/Documents/techman_robot/src/techman_robot/tm_driver/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'tm_driver' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'yhtsai <yhtsai@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'tm_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/schwarmcyc/Documents/techman_robot/src/techman_robot/tm_driver/${idir}'.  Ask the maintainer 'yhtsai <yhtsai@todo.todo>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${tm_driver_dep}_FOUND)
      find_package(${tm_driver_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${tm_driver_dep} REQUIRED ${depend_list})
  endif()
